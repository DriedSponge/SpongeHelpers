...
var ErrorFormat = "color:red;font-size:14px";
...
// CONCATENATED MODULE: ./src/html/reset.ts
...
// CONCATENATED MODULE: ./src/html/remove.ts
...
// CONCATENATED MODULE: ./src/html/text.ts

var text_text = function (text) {
    this.selected.forEach(function (element) {
        element.textContent = text;
    });
    return this;
};
SpongeHelpers.prototype.text = text_text;
...
// CONCATENATED MODULE: ./src/events/formInit.ts


//@ts-ignore
var axios = __webpack_require__(9);
var formInit = function (args) {
...
// CONCATENATED MODULE: ./src/data/checked.ts

var checked = function (value) {
    if (typeof value === 'boolean') {
        this.selected.forEach(function (elm) {
            elm.checked = value;
        });
        return this;
    }
...
// CONCATENATED MODULE: ./src/data/disabled.ts
...
// CONCATENATED MODULE: ./src/sass/main.scss
// extracted by mini-css-extract-plugin

// CONCATENATED MODULE: ./src/sass/index.ts
